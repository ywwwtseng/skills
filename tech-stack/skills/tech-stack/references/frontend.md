...
| SvelteKit | 輕量、runtime 小，適合效能敏感或小團隊 |
...
| 情境 | 首選 | 替代 | 避免 |
|---|---|---|---|
| 需要 SEO + 團隊熟 React | Next.js | Remix（非標準候選） | Vite SPA |
| 需要 SEO + 團隊熟 Vue | Nuxt | Astro + Vue | — |
...
| 1 人 side project、快速上線 | Next.js（Vercel 一鍵部署） | Vite + React | — |
| 行動 App 後端、無 Web UI | 無前端 | — | — |

## 額外判斷

- 團隊語言未勾 TypeScript（如純 Python / Go / Rust）但需要 UI：仍推薦 TypeScript 框架，但在「風險」標注學習成本；若 UI 極簡可提 HTMX + 後端模板（非標準候選）。
